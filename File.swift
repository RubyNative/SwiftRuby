...
public class File : IO {
    ...
    public class func new( file_name: string_like, _ mode: string_like = "r", _ perm: Int? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> File? {
    ...
    public class func open( file_name: string_like, _ mode: string_like = "r", _ perm: Int? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> File? {
        return new( file_name, mode, perm, file: file, line: line )
    }

    public class func absolute_path( file_name: string_like, _ dir_string: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        var baseURL: NSURL?
    ...
    public class func basename( file_name: string_like, _ suffix: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
    ...
    public class func birthtime( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Time? {
        return Stat( file_name, file: file, line: line )?.ctime
    }

    public class func blockdev( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.blockdev
    }

    public class func chardev( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.chardev
    }

    public class func chmod( mode_int: Int, _ file_names: array_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        var ok = true
    ...
    public class func chown( owner_s: string_like?, _ group_s: string_like?, _ file_names: array_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
    ...
    public class func user_uid( user_s: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Int? {
    ...
    public class func group_gid( group_s: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Int? {
        var buff = [Int8]( count: Int(PATH_MAX), repeatedValue: 0 )
    ...
    public class func ctime( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Time? {
        return birthtime( file_name )
    }

    public class func delete( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return unixOK( "File.delete '\(file_name.to_s)'", Darwin.unlink( file_name.to_s ), file: file, line: line )
    }

    public class func directory( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.directory
    }

    public class func dirname( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        return NSURL( fileURLWithPath: file_name.to_s ).URLByDeletingLastPathComponent?.path
    }

    public class func executable( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.executable
    }

    public class func executable_real( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.executable_real
    }

    public class func exist( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return Stat( file_name, file: nil ) != nil
    }

    public class func exists( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return exist( file_name )
    }

    public class func expand_path( file_name: string_like, _ dir_string: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        return NSURL( fileURLWithPath: file_name.to_s ).URLByStandardizingPath?.path
    }

    public class func extname( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        return NSURL( fileURLWithPath: file_name.to_s ).pathExtension
    }

    public class func file( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return Stat( file_name, file: file, line: line )?.file == true
    }

//    public class func fnmatch( pattern: string_like, _ path: string_like, _ flags: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
//        RKNotImplemented( "File.fnmatch" )
//        return false
//    }

    public class func ftype( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        return Stat( file_name, file: file, line: line )?.ftype
    }

    public class func grpowned( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.grpowned
    }

    public class func identical( file_1: string_like, _ file_2: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
    ...
    public class func lchmod( mode_int: Int, _ file_names: array_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        var ok = true
        for file_name in file_names.to_a {
    ...
    public class func lchown( owner_s: string_like?, _ group_s: string_like?, _ file_names: array_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
    ...
    public class func link( old_name: string_like, _ new_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return unixOK( "File.link '\(old_name.to_s)' '\(new_name.to_s)'", Darwin.link( old_name.to_s, new_name.to_s ), file: file, line: line )
    }

    public class func lstat( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Stat? {
        return Stat( file_name, statLink: true, file: file, line: line )
    }

    public class func mtime( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Time? {
        return Stat( file_name, file: file, line: line )?.mtime
    }

    public class func owned( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.owned
    }

    public class func path( path: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String {
        return path.to_s ////
    }

    public class func pipe( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.pipe
    }

    public class func readable( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.readable
    }

    public class func readable_real( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.readable_real
    }

    public class func readlink( link_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
    ...
    public class func realdirpath( file_name: string_like, _ dir_string: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        if dir_string != nil {
    ...
    public class func realpath( file_name: string_like, _ dir_string: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        if dir_string != nil {
    ...
    public class func extremoved( file_name: string_like, _ suffix: string_like? = nil, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> String? {
        return NSURL( fileURLWithPath: file_name.to_s ).URLByDeletingPathExtension?.path
    }

    public class func rename( old_name: string_like, _ new_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return unixOK( "File.rename '\(old_name.to_s)' '\(new_name.to_s)'", Darwin.rename( old_name.to_s, new_name.to_s ), file: file, line: line )
    }

    public class func setgid( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.setgid
    }

    public class func setuid( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.setuid
    }

    public class func size( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Int? {
        return Stat( file_name, file: file, line: line )?.size
    }

    public class func socket( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.socket
    }

    public class func split( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> [String?] {
        return [dirname(file_name), basename(file_name)]
    }

    public class func stat( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Stat? {
        return Stat( file_name, file: file, line: line )
    }

    public class func sticky( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.sticky
    }

    public class func symlink( old_name: string_like, _ new_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return unixOK( "File.symlink '\(old_name.to_s)' '\(new_name.to_s)'", Darwin.symlink( old_name.to_s, new_name.to_s ), file: file, line: line )
    }

    public class func truncate( file_name: string_like, _ integer: Int, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
        return unixOK( "File.truncate '\(file_name.to_s)' \(integer)", Darwin.truncate( file_name.to_s, off_t(integer) ), file: file, line: line )
    }

    public class func unlink( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
    ...
    public class func writable( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.writable
    }

    public class func writable_real( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
        return Stat( file_name, file: file, line: line )?.writable_real
    }

    public class func write( file_name: string_like, string: data_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> fixnum? {
        return File( filepath: file_name, mode: "w", file: file, line: line )?.write( string )
    }

    public class func zero( file_name: string_like, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool? {
    ...
    public func chown( owner_s: string_like?, _ group_s: string_like?, file: StaticString = __FILE__, line: UInt = __LINE__ ) -> Bool {
